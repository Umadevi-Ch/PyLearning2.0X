...
# To access the private variable  we can create a public function
    def public_fn(self):
...
jp_chase.if_you_are_auth(True) # if it is False then in the output Not allowed statement will be printed
jp_chase.public_fn()